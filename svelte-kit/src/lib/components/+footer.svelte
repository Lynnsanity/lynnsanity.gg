...
<footer class="bg-white rounded-lg shadow dark:bg-transparent m-4">
    <div class="w-full max-w-screen-xl mx-auto p-4 md:py-8">
            ...
            <ul class="flex flex-wrap text-center items-center mb-6 text-sm font-medium text-gray-500 sm:mb-0 dark:text-gray-400">
                ...
                <li>
                    ...
                    <a href="https://www.facebook.com/lynnelle.saavedra">
                        <button id="facebook" class="fixed sticky h-12 w-12 transform rounded-full border-2 border-blue-600 bg-white bg-opacity-10 text-2xl text-blue-600 duration-500 hover:-translate-y-3 hover:bg-blue-600 hover:text-white">
        ...
        <span class="block text-sm text-gray-500 sm:text-center dark:text-white">© 2023 <a href="https://lynnsanity.io" class="hover:underline">Lynnsanity™</a>
            <br>
